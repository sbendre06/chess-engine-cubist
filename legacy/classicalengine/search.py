...
def _ordered_moves(
    ...
    tactical = [m for m in legal if (board.is_capture(m) or m.promotion is not None) and m not in ordered]
    quiet = [m for m in legal if m not in ordered and m not in killer_moves and m not in tactical]
